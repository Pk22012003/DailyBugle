    ...
    <main class="container">
        <div class="row">
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>'Friends' actor Matthew Perry passes away after apparent drowning: Report</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>Delhi Air Pollution News Live Updates: Marginal dip in pollution levels in capital, AQI in 'very poor' category</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>Virat Kohli equals Sachin Tendulkar's record for most hundreds in one-day internationals</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>India sends emergency relief to earthquake-hit Nepal, reaffirms PM Modi's 'Neighbourhood First' policy</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>NASA surprised to discover 'dinky' moon orbiting asteroid in close flyby</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>Recent Developments in the Israel-Palestine Conflict</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>Israeli-Palestinian Conflict Flares Up</a></p>
                    </div>
                </div>
            </div>
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="card-body">
                        <p class="card-text"><a id="linkc" href="https://www.google.com/" onClick={handleClick}>Pro-Palestinian demonstrators in cities across Europe rallied together and called for a cease fire, chanting, "Stop the massacre in Gaza" and "Cease fire now."</a></p>
                    </div>
                </div>
            </div>
            <div id="line1"></div>
